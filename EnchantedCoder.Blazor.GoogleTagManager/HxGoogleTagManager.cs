...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxGoogleTagManager">https://EnchantedCoder.blazor.eu/components/HxGoogleTagManager</see>
/// </summary>
/// <inheritdoc/>
public class HxGoogleTagManager : IHxGoogleTagManager, IAsyncDisposable
{
	...
	public async Task InitializeAsync()
	{
		...
		jsModule ??= await jsRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/EnchantedCoder.Blazor.GoogleTagManager/" + nameof(HxGoogleTagManager) + ".js");

...
/// </summary>
public interface IEcGoogleTagManager
{
	/// <summary>
	/// Initializes the GTM support.
	/// Called automatically within first <c>Push</c> call (incl. <see cref="EcGoogleTagManagerPageViewTracker"/> calls).
	...
	/// Consider using <see cref="EcGoogleTagManagerPageViewTracker"/> instead of manual handling.
	/// </summary>
	Task PushPageViewAsync(object additionalData = null);

	/// <summary>
	/// Used by <see cref="EcGoogleTagManagerPageViewTracker"/> to track location changes.
	/// </summary>

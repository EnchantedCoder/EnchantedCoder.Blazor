...
/// For buttons with dropdowns use more specific <see cref="EcDropdownButtonGroup"/>.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcDropdown">https://EnchantedCoder.blazor.eu/components/EcDropdown</see>
/// </summary>
public partial class EcDropdown : ComponentBase, IDropdownContainer
{
	/// <summary>

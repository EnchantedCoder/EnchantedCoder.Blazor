...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxOffcanvas">https://EnchantedCoder.blazor.eu/components/HxOffcanvas</see>
/// </summary>
public partial class HxOffcanvas : IAsyncDisposable
{
	...
	protected override async Task OnAfterRenderAsync(bool firstRender)
	{
		...
		if (shouldOpenOffcanvas)
		{
			...
			jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxOffcanvas));
			if (disposed)
			{
				return;
			}

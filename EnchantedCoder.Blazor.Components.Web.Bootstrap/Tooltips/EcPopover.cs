...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcPopover">https://EnchantedCoder.blazor.eu/components/EcPopover</see>
/// </summary>
public class EcPopover : EcTooltipInternalBase
{
	/// <summary>
	/// Application-wide defaults for the <see cref="EcPopover"/> and derived components.
	/// </summary>
	...
	protected override string JsModuleName => nameof(EcPopover);

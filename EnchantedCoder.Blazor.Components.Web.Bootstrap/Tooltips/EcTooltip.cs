...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcTooltip">https://EnchantedCoder.blazor.eu/components/EcTooltip</see>
/// </summary>
public class EcTooltip : EcTooltipInternalBase
{
	/// <summary>
	/// Application-wide defaults for the <see cref="EcTooltip"/> and derived components.
	/// </summary>
	...
	protected override string JsModuleName => nameof(EcTooltip);

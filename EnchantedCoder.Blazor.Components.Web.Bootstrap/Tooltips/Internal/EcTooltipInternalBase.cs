...
/// <summary>
/// Common implementation for <see cref="EcTooltip"/> and <see cref="EcPopover"/>.
/// </summary>
/// <remarks>
/// We do not want EcPopover to derive from EcTooltip directly as we want
/// to keep the API consistent, e.g. EcPopover.Placement = PopoverPlacement.Auto, not TooltipPlacement.Auto or anything else.
/// </remarks>
public abstract class EcTooltipInternalBase : ComponentBase, IAsyncDisposable
{
	...
	private DotNetObjectReference<EcTooltipInternalBase> dotnetObjectReference;
	...
	protected EcTooltipInternalBase()
	{
	...
	private async Task EnsureJsModuleAsync()
	{
		...
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(JsModuleName);
	}

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcTreeView">https://EnchantedCoder.blazor.eu/components/EcTreeView</see>
/// </summary>
/// <typeparam name="TItem">Type of tree data item.</typeparam>
public partial class EcTreeView<TItem> : ComponentBase
{
	/// <summary>

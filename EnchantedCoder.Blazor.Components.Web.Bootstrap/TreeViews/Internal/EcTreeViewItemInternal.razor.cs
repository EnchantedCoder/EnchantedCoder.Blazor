...
public partial class EcTreeViewItemInternal<TItem> : ComponentBase
{
	...
	[CascadingParameter] protected EcTreeView<TItem> TreeViewContainer { get; set; }

	private string collapseId = "ec" + Guid.NewGuid().ToString("N");

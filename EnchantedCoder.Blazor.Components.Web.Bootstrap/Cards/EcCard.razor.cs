...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcCard">https://EnchantedCoder.blazor.eu/components/EcCard</see>
/// </summary>
public partial class EcCard
{
	/// <summary>
	/// Application-wide defaults for <see cref="EcCard"/> and derived components.
	/// </summary>

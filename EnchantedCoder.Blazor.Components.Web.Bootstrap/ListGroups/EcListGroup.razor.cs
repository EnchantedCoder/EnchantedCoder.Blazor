...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcListGroup">https://EnchantedCoder.blazor.eu/components/EcListGroup</see>
/// </summary>
public partial class EcListGroup
{
	/// <summary>
	...
	/// <summary>
	/// Additional attributes to be splatted onto an underlying <see cref="EcListGroup"/> component.
	/// </summary>

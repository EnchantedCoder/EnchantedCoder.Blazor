...
public class EcGridColumn<TItem> : EcGridColumnBase<TItem>
{
	/// <summary>
	...
	private RenderFragment GetDefaultItemPlaceholder(GridPlaceholderCellContext context)
	{
		...
		{
			builder.OpenComponent<EcPlaceholderContainer>(100);
			builder.AddAttribute(101, nameof(EcPlaceholderContainer.Animation), PlaceholderAnimation.Glow);
			builder.AddAttribute(102, nameof(EcPlaceholderContainer.ChildContent), (RenderFragment)((RenderTreeBuilder builder2) =>
			{
				builder2.OpenComponent<EcPlaceholder>(200);
				builder2.AddAttribute(201, nameof(EcPlaceholder.Columns), placeholderColumns[context.Index % placeholderColumns.Length]);
				builder2.CloseComponent(); // EcPlaceholder
			}));

			builder.CloseComponent(); // EcPlaceholderContainer
		};
	}

...
public class EcMultiSelectGridColumnInternal<TItem> : EcGridColumnBase<TItem>
{
	...
	/// <inheritdoc />
	protected override string GetId() => nameof(EcMultiSelectGridColumnInternal<object>);

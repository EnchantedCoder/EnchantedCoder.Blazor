...
/// <summary>
/// Column for displaying the <see cref="EcContextMenu"/> in the <see cref="EcGrid"/>.
/// </summary>
public class EcContextMenuGridColumn<TItem> : EcGridColumnBase<TItem>
{
	/// <summary>
	...
	/// <inheritdoc />
	protected override string GetId() => nameof(EcContextMenuGridColumn<object>);
	...
	{
		string cssClass = CssClassHelper.Combine("ec-context-menu-grid-column", ItemCssClass, ItemCssClassSelector?.Invoke(item));

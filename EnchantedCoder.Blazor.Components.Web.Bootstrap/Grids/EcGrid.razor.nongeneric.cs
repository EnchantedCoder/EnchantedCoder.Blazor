...
/// <summary>
/// Non-generic API for the <see cref="EcGrid{TItem}"/> component.
/// </summary>
/// <remarks>
/// Marker for resources for <see cref="EcGrid{TItem}"/>.
/// It is unfriendly to create resources for generic classes.
/// </remarks>
public sealed class EcGrid
{
	/// <summary>
	/// Application-wide defaults for the <see cref="EcGrid{TItem}"/> and derived components.
	/// </summary>

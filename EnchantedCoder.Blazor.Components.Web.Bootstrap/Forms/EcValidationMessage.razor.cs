...
/// Used by <see cref="EcInputBase{TValue}"/> and derived components.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcValidationMessage">https://EnchantedCoder.blazor.eu/components/EcValidationMessage</see>
/// </summary>
public partial class EcValidationMessage<TValue> : ComponentBase, IDisposable
{
	...
	/// <summary>
	/// Constructs an instance of <see cref="EcValidationMessage{TValue}"/>.
	/// </summary>
	public EcValidationMessage()
	{

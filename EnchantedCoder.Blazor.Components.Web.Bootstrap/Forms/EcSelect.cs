...
/// <summary>
/// Select - DropDownList - single-item picker. Consider creating custom picker derived from <see cref="EcSelectBase{TValueType, TItem}"/>.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcSelect">https://EnchantedCoder.blazor.eu/components/EcSelect</see>
/// </summary>
/// <typeparam name="TValue">Type of value.</typeparam>
/// <typeparam name="TItem">Type of items.</typeparam>
public class EcSelect<TValue, TItem> : EcSelectBase<TValue, TItem>
{
	/// <summary>

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxAutosuggest">https://EnchantedCoder.blazor.eu/components/HxAutosuggest</see>
/// </summary>
/// <remarks>
...
public class HxAutosuggest<TItem, TValue> : HxInputBase<TValue>, IInputWithSize, IInputWithPlaceholder, IInputWithLabelType
{
	...
	protected override void BuildRenderInput(RenderTreeBuilder builder)
	{
		...
		builder.AddAttribute(1012, nameof(HxAutosuggestInternal<TItem, TValue>.Placeholder), (labelTypeEffective == EnchantedCoder.Blazor.Components.Web.Bootstrap.LabelType.Floating) ? "placeholder" : Placeholder);

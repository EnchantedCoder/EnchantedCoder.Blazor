...
/// <summary>
/// Data-based list of radio buttons. Consider creating custom picker derived from <see cref="EcRadioButtonListBase{TValueType, TItem}"/>.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcRadioButtonList">https://EnchantedCoder.blazor.eu/components/EcRadioButtonList</see>
/// </summary>
/// <typeparam name="TValue">Type of value.</typeparam>
/// <typeparam name="TItem">Type of items.</typeparam>
public class EcRadioButtonList<TValue, TItem> : EcRadioButtonListBase<TValue, TItem>
{
	/// <summary>

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcInputPercent">https://EnchantedCoder.blazor.eu/components/EcInputPercent</see>
/// </summary>
public class EcInputPercent<TValue> : EcInputNumber<TValue>
{
	private static HashSet<Type> supportedTypes = new HashSet<Type> { typeof(float), typeof(double), typeof(decimal) };

	public EcInputPercent()
	{

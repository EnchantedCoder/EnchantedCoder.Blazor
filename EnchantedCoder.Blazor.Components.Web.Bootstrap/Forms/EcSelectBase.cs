...
/// <summary>
/// Base class for EcSelect and custom-implemented SELECT-pickers.
/// </summary>
/// <typeparam name="TValue">Type of value.</typeparam>
/// <typeparam name="TItem">Type of items.</typeparam>
public abstract class EcSelectBase<TValue, TItem> : EcInputBaseWithInputGroups<TValue>, IInputWithSize, IInputWithLabelType
{
	/// <summary>
	/// Return <see cref="EcSelect{TValue, TItem}"/> defaults.
	/// Enables to not share defaults in descendants with base classes.
	/// Enables to have multiple descendants which differs in the default values.
	/// </summary>
	protected override SelectSettings GetDefaults() => EcSelect.Defaults;

	/// <summary>
	/// Set of settings to be applied to the component instance (overrides <see cref="EcSelect.Defaults"/>, overridden by individual parameters).
	/// </summary>
	...
	protected InputSize InputSizeEffective => this.InputSize ?? GetSettings()?.InputSize ?? GetDefaults()?.InputSize ?? throw new InvalidOperationException(nameof(InputSize) + " default for " + nameof(EcSelect) + " has to be set.");
	...
	/// <inheritdoc cref="EcInputBase{TValue}.EnabledEffective" />

...
/// <summary>
/// Checkbox input.<br />
/// (Replaces the former <c>EcInputCheckbox</c> component which was dropped in v 4.0.0.)
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcCheckbox">https://EnchantedCoder.blazor.eu/components/EcCheckbox</see>
/// </summary>
public class EcCheckbox : EcInputBase<bool>
{
	/// <summary>
	...
	[Inject] protected IStringLocalizer<EcCheckbox> Localizer { get; set; }

	/// <inheritdoc cref="EcInputBase{TValue}.CoreInputCssClass" />
	private protected override string CoreInputCssClass => "form-check-input";

	/// <inheritdoc cref="EcInputBase{TValue}.CoreCssClass" />
	...
	/// <summary>
	/// CSS class for <c>form-check</c> element (e.g. allows adding <c>form-switch</c> in derived <see cref="EcSwitch"/>).
	/// </summary>

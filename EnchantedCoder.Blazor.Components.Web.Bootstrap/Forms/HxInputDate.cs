...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxInputDate">https://EnchantedCoder.blazor.eu/components/HxInputDate</see>
/// </summary>
/// <remarks>
...
public class HxInputDate<TValue> : HxInputBase<TValue>, IInputWithPlaceholder, IInputWithSize, IInputWithLabelType
{
	...
	protected virtual void BuildRenderInputCore(RenderTreeBuilder builder)
	{
		...
		builder.AddAttribute(204, nameof(HxInputDateInternal<TValue>.Placeholder), (labelTypeEffective == EnchantedCoder.Blazor.Components.Web.Bootstrap.LabelType.Floating) ? "placeholder" : Placeholder);

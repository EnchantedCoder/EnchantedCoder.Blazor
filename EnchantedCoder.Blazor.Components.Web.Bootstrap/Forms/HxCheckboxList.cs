...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxCheckboxList">https://EnchantedCoder.blazor.eu/components/HxCheckboxList</see>
/// </summary>
	...
	protected override void BuildRenderInput(RenderTreeBuilder builder)
	{
		...
		if (itemsToRender.Count > 0)
		{
			...
			foreach (var item in itemsToRender)
			{
				...
				builder.AddAttribute(51, nameof(HxCheckbox.ValidationMessageMode), EnchantedCoder.Blazor.Components.Web.Bootstrap.ValidationMessageMode.None);

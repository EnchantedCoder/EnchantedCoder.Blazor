...
/// <summary>
/// Numeric input.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcInputNumber">https://EnchantedCoder.blazor.eu/components/EcInputNumber</see>
/// </summary>
/// <remarks>
/// Defaults located in separate non-generic type <see cref="EcInputNumber"/>.
/// </remarks>
...
public class EcInputNumber<TValue> : EcInputBaseWithInputGroups<TValue>, IInputWithSize, IInputWithPlaceholder, IInputWithLabelType
{
	...
	/// </summary>
	protected override InputNumberSettings GetDefaults() => EcInputNumber.Defaults;

	/// <summary>
	/// Set of settings to be applied to the component instance (overrides <see cref="EcInputNumber.Defaults"/>, overridden by individual parameters).
	/// </summary>
	...
	/// If not set (neither with <see cref="Settings"/> nor <see cref="EcInputNumber.Defaults"/>, i.e. <c>null</c>),
	...
	protected InputSize InputSizeEffective => this.InputSize ?? GetSettings()?.InputSize ?? GetDefaults()?.InputSize ?? throw new InvalidOperationException(nameof(InputSize) + " default for " + nameof(EcInputNumber) + " has to be set.");
	...
	[Inject] private protected IStringLocalizer<EcInputNumber> StringLocalizer { get; set; }
	...
	protected override void BuildRenderInput(RenderTreeBuilder builder)
	{
		...
		// We want the value of the EcInputNumber to be updated (re-rendered) when the user input changes, even if FormatValueAsString(Value) hasn't changed.

...
public class EcFormValueComponentRenderer : ComponentBase
{
	/// <summary>
	...
	protected virtual void BuildRenderLabel(RenderTreeBuilder builder)
	{
		...
		builder.OpenComponent(1, typeof(EcFormValueComponentRenderer_Label));
		builder.AddAttribute(2, nameof(EcFormValueComponentRenderer_Label.FormValueComponent), FormValueComponent);

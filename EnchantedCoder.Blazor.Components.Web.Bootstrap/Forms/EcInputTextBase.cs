...
/// </summary>
public abstract class EcInputTextBase : EcInputBaseWithInputGroups<string>, IInputWithSize, IInputWithPlaceholder, IInputWithLabelType
{
	/// <summary>
	/// Return <see cref="EcInputText"/> defaults.
	...
	/// <summary>
	/// Set of settings to be applied to the component instance (overrides <see cref="EcInputText.Defaults"/>, overridden by individual parameters).
	/// </summary>

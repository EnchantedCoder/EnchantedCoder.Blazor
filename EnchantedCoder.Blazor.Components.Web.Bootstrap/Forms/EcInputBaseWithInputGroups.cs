...
/// Extends <seealso cref="EcInputBase{TValue}" /> class.
...
/// </summary>
public abstract class EcInputBaseWithInputGroups<TValue> : EcInputBase<TValue>, IFormValueComponentWithInputGroups
{
	/// <summary>

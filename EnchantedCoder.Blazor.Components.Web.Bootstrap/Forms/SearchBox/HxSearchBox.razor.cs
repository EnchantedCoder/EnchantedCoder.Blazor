...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxSearchBox">https://EnchantedCoder.blazor.eu/components/HxSearchBox</see>
/// </summary>
...
public partial class HxSearchBox<TItem> : IAsyncDisposable
{
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxSearchBox));
	}

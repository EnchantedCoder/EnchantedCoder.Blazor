...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcCollapse">https://EnchantedCoder.blazor.eu/components/EcCollapse</see>
/// </summary>
public partial class EcCollapse : IAsyncDisposable
{
	/// <summary>
	/// Element ID. To be referenced by <see cref="EcCollapseToggleButton.CollapseTarget"/>.
	...
	private DotNetObjectReference<EcCollapse> dotnetObjectReference;
	private IJSObjectReference jsModule;
	private string defaultId = "ec" + Guid.NewGuid().ToString("N");
	...
	public override async Task SetParametersAsync(ParameterView parameters)
	{
		...
		// to be able to use another default value in ancestors (EcNavbarCollapse)
	...
	/// </summary>
	[JSInvokable("EcCollapse_HandleJsShow")]
	...
	/// this covers both user-interaction (DOM state) and Blazor-interaction (EcAccordion.ExpandedItemId change)
	/// </remarks>
	[JSInvokable("EcCollapse_HandleJsShown")]
	...
	/// </summary>
	[JSInvokable("EcCollapse_HandleJsHide")]
	...
	/// </summary>
	[JSInvokable("EcCollapse_HandleJsHidden")]
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(EcCollapse));
	}

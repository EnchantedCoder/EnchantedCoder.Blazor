...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxCollapse">https://EnchantedCoder.blazor.eu/components/HxCollapse</see>
/// </summary>
public partial class HxCollapse : IAsyncDisposable
{
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxCollapse));
	}

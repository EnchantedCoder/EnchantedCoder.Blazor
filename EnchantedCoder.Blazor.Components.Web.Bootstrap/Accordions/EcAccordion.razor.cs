...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcAccordion">https://EnchantedCoder.blazor.eu/components/EcAccordion</see>
/// </summary>
public partial class EcAccordion
{
	/// <summary>
	...
	protected internal string Id { get; set; } = "ec" + Guid.NewGuid().ToString("N");

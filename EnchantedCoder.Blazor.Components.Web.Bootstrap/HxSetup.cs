...
public static class HxSetup
{
	...
	internal static string VersionIdentifierEnchantedCoderBlazorBootstrap { get; } = EnchantedCoder.Blazor.Components.Web.JSRuntimeExtensions.GetAssemblyVersionIdentifierForUri(typeof(HxSetup).Assembly);
}

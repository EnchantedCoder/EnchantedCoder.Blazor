...
public partial class EcContextMenuItem : ComponentBase, ICascadeEnabledComponent
{
	/// <summary>
	/// Item text.
	/// </summary>
	...
	/// <summary>
	/// Displays <see cref="EcMessageBox" /> to get a confirmation.
	/// </summary>
	...
	[Inject] protected IServiceProvider ServiceProvider { get; set; } // optional IEcMessageBoxService, fallback to JS-confirm

	protected IEcMessageBoxService MessageBox { get; set; }
	...
	protected override void OnInitialized()
	{
		...
		MessageBox = ServiceProvider.GetService<IEcMessageBoxService>(); // conditional, does not have to be registered
	}

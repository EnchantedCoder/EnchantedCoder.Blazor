...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcContextMenu">https://EnchantedCoder.blazor.eu/components/EcContextMenu</see>
/// </summary>
public partial class EcContextMenu
{
	/// <summary>
	/// Application-wide defaults for <see cref="EcContextMenu"/> and derived components.
	/// </summary>
	public static ContextMenuSettings Defaults { get; set; }

	static EcContextMenu()
	{
	...
	protected IconBase IconEffective => this.Icon ?? this.GetSettings()?.Icon ?? GetDefaults().Icon ?? throw new InvalidOperationException(nameof(Icon) + " default for " + nameof(EcContextMenu) + " has to be set.");
	...
	protected DropdownMenuAlignment DropdownMenuAlignmentEffective => this.DropdownMenuAlignment ?? this.GetSettings()?.DropdownMenuAlignment ?? GetDefaults().DropdownMenuAlignment ?? throw new InvalidOperationException(nameof(DropdownMenuAlignment) + " default for " + nameof(EcContextMenu) + " has to be set.");

	/// <summary>
	/// Items of the context menu. Use <see cref="EcContextMenuItem"/> components.
	/// </summary>
	[Parameter] public RenderFragment ChildContent { get; set; }

	private string id = "ec" + Guid.NewGuid().ToString("N");
}

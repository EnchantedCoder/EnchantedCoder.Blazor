...
/// <summary>
/// Single tab for <see cref="EcTabPanel"/>.
/// </summary>
public class EcTab : ComponentBase, ICascadeEnabledComponent, IAsyncDisposable
{
	/// <summary>
	/// Cascading parameter to register the tab.
	/// </summary>
	[CascadingParameter(Name = EcTabPanel.TabsRegistrationCascadingValueName)]
	protected CollectionRegistration<EcTab> TabsRegistration { get; set; }

	/// <summary>
	/// ID of the tab (<see cref="EcTabPanel.ActiveTabId"/>).
	...
	/// <summary>
	/// Raised when the tab is deactivated (another tab is activates or when <see cref="EcTabPanel"/> is disposed).
	/// </summary>
	...
	protected override void OnInitialized()
	{
		...
		Contract.Requires<InvalidOperationException>(TabsRegistration != null, $"{nameof(EcTab)} has to be inside {nameof(EcTabPanel)}.");

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcPlaceholder">https://EnchantedCoder.blazor.eu/components/EcPlaceholder</see>
/// </summary>
public partial class EcPlaceholder : ILayoutColumnComponent
{
	/// <summary>
	/// Application-wide defaults for the <see cref="EcPlaceholder"/> and derived components.
	/// </summary>
	public static PlaceholderSettings Defaults { get; set; }

	static EcPlaceholder()
	{
	...
	protected PlaceholderSize SizeEffective => this.Size ?? this.GetSettings()?.Size ?? PlaceholderContainer?.Size ?? GetDefaults().Size ?? throw new InvalidOperationException(nameof(Size) + " default for " + nameof(EcPlaceholder) + " has to be set.");

	/// <summary>
	/// Color of the placeholder.
	/// </summary>
	[Parameter] public ThemeColor? Color { get; set; }
	protected ThemeColor ColorEffective => this.Color ?? this.GetSettings()?.Color ?? PlaceholderContainer?.Color ?? GetDefaults().Color ?? throw new InvalidOperationException(nameof(Color) + " default for " + nameof(EcPlaceholder) + " has to be set.");
	...
	[CascadingParameter] protected EcPlaceholderContainer PlaceholderContainer { get; set; }
	...
	private string GetSizeCssClass()
	{
		return this.SizeEffective switch
		{
			...
			_ => throw new InvalidOperationException($"Unknown {nameof(EcPlaceholder)}.{nameof(Size)} value {this.SizeEffective:g}.")
		};
	}
}

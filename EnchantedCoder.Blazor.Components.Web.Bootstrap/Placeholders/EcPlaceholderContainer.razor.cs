...
/// <summary>
/// Optional container for the <see cref="EcPlaceholder"/> components where you can set the animation and some common properties
/// for all placeholders contained.
/// </summary>
public partial class EcPlaceholderContainer
{
	/// <summary>
	/// Application-wide defaults for <see cref="EcPlaceholderContainer"/> and derived components.
	/// </summary>
	public static PlaceholderContainerSettings Defaults { get; set; }

	static EcPlaceholderContainer()
	{
	...
	protected PlaceholderAnimation AnimationEffective => this.Animation ?? this.GetSettings()?.Animation ?? GetDefaults().Animation ?? throw new InvalidOperationException(nameof(Animation) + " default for " + nameof(EcPlaceholderContainer) + " has to be set.");

	/// <summary>
	/// Size of the placeholders (propagated to the child <see cref="EcPlaceholder"/>s).
	/// </summary>
	[Parameter] public PlaceholderSize? Size { get; set; }

	/// <summary>
	/// Color of the placeholders (propagated to the child <see cref="EcPlaceholder"/>s).
	/// </summary>
	[Parameter] public ThemeColor? Color { get; set; }

	/// <summary>
	/// Content of the placeholder container (put your <see cref="EcPlaceholder"/>s here).
	/// </summary>

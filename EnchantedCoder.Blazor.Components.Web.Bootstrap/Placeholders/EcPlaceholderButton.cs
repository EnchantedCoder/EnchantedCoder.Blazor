...
/// Derives from <see cref="EcButton"/> (adds <c>placeholder</c> class and changes <c>Enabled</c> default to <c>false</c>).<br/>
/// Set the size of the button by using the <see cref="Columns"/> parameter.
/// </summary>
public class EcPlaceholderButton : EcButton, ILayoutColumnComponent
{

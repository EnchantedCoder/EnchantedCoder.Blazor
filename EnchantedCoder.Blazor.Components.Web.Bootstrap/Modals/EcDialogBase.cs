...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcDialogBase">https://EnchantedCoder.blazor.eu/components/EcDialogBase</see>
/// </summary>
public abstract class EcDialogBase<TResult> : ComponentBase
{
#pragma warning disable SA1307 // Accessible fields must begin with upper-case letter
	protected internal EcModal modal; // for EcModal @ref
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter

	/// <summary>
	/// Returns the <see cref="EcModal"/> component which this component control. Override when you do not want to use modal field set using @ref.
	/// </summary>
	protected virtual EcModal Modal => modal;
...
#pragma warning restore BL0005 // Component parameter should not be set outside of its component.
	...
	protected override void OnAfterRender(bool firstRender)
	{
		...
		Contract.Assert<InvalidOperationException>(Modal != null, $"Dialog must contain {nameof(EcModal)} component with @ref=\"{nameof(modal)}\".");
		firstRendered = true;
	}
}

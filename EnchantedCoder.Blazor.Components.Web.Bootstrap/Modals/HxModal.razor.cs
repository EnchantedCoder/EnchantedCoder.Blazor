...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxModal">https://EnchantedCoder.blazor.eu/components/HxModal</see>
/// </summary>
public partial class HxModal : IAsyncDisposable
{
	...
	protected override async Task OnAfterRenderAsync(bool firstRender)
	{
		...
		if (shouldOpenModal)
		{
			...
			jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxModal));
			if (disposed)
			{
				return;
			}

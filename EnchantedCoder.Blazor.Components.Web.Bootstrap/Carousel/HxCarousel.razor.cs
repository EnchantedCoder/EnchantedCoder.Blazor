...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxCarousel">https://EnchantedCoder.blazor.eu/components/HxCarousel</see>
/// </summary>
public partial class HxCarousel : IAsyncDisposable
{
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxCarousel));
	}

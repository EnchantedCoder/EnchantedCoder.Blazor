...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcCarousel">https://EnchantedCoder.blazor.eu/components/EcCarousel</see>
/// </summary>
public partial class EcCarousel : IAsyncDisposable
{
	...
	private DotNetObjectReference<EcCarousel> dotnetObjectReference;
	private ElementReference elementReference;
	private List<EcCarouselItem> items;
	private CollectionRegistration<EcCarouselItem> itemsRegistration;
	private bool disposed = false;

	public EcCarousel()
	{
		dotnetObjectReference = DotNetObjectReference.Create(this);
		items = new List<EcCarouselItem>();
		itemsRegistration = new CollectionRegistration<EcCarouselItem>(items,
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(EcCarousel));
	}


	[JSInvokable("EcCarousel_HandleSlide")]
	...
	[JSInvokable("EcCarousel_HandleSlid")]

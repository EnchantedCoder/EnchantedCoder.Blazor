...
/// <summary>
/// Temporary (?) NavLink component to be used with <see cref="EcScrollspy"/> where <c>#id</c> anchors are required and <c>page-route#id</c> cannot be used.
/// </summary>
public partial class EcScrollspyNavLink
{
	/// <summary>
	...
	{
		Contract.Requires<InvalidOperationException>((Href is not null) && (Href.StartsWith("#")), $"{nameof(EcScrollspyNavLink)}.{nameof(EcScrollspyNavLink.Href)} has to start with #. Use only for local elements.");
	}

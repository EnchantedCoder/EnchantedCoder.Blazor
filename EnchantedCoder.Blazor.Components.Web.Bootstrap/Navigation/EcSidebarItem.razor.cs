...
/// <summary>
/// Item for the <see cref="EcSidebar"/>.
/// </summary>
public partial class EcSidebarItem : IAsyncDisposable
{
	/// <summary>
	/// Item text.
	/// </summary>
	...
	/// <summary>
	/// Inner custom content for the <see cref="EcSidebarItem"/>.
	/// </summary>
	...
	[CascadingParameter] protected EcSidebarItem ParentSidebarItem { get; set; }
	...
	protected List<EcSidebarItem> childItems;
	internal CollectionRegistration<EcSidebarItem> ChildItemsRegistration { get; }

	protected EcCollapse collapseComponent;
	protected bool disposed;
	protected bool isMatch;
	protected bool expanded;

	public EcSidebarItem()
	{
		childItems = new();
	...
	{
		Contract.Requires<InvalidOperationException>(ParentSidebar is not null, $"{nameof(EcSidebarItem)} has to be placed inside {nameof(EcSidebar)}.");

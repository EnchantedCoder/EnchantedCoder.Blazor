...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcScrollspy">https://EnchantedCoder.blazor.eu/components/EcScrollspy</see>
/// </summary>
public partial class EcScrollspy : IAsyncDisposable
{
	/// <summary>
	/// ID of the <see cref="EcNav"/> or list-group with scrollspy navigation.
	/// </summary>
	[Parameter, EditorRequired] public string TargetId { get; set; }

	/// <summary>
	/// Scrollspy additional CSS class. Added to main div (.ec-scrollspy).
	/// </summary>
	[Parameter] public string CssClass { get; set; }

	/// <summary>
	/// Content to be spied. Elements with IDs are required (corresponding IDs to be used in <see cref="EcNavLink.Href"/>).
	/// </summary>
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(EcScrollspy));
	}

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxScrollspy">https://EnchantedCoder.blazor.eu/components/HxScrollspy</see>
/// </summary>
public partial class HxScrollspy : IAsyncDisposable
{
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxScrollspy));
	}

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxAnchorFragmentNavigation">https://EnchantedCoder.blazor.eu/components/HxAnchorFragmentNavigation</see>
/// </summary>
public class HxAnchorFragmentNavigation : ComponentBase, IAsyncDisposable
{
	...
	public async Task ScrollToAnchorAsync(string anchor)
	{
		...
		{
			jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxAnchorFragmentNavigation));

...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcSidebar">https://EnchantedCoder.blazor.eu/components/EcSidebar</see>
/// </summary>
public partial class EcSidebar : ComponentBase
{
	/// <summary>
	/// Sidebar header.
	/// </summary>
	...
	/// <summary>
	/// Sidebar items. Use <see cref="EcSidebarItem"/>.
	/// </summary>
	...
	/// <summary>
	/// Indicates whether the <see cref="EcSidebar"/> is collapsed, can be used to alter the state (expand or collapse the sidebar).
	/// </summary>
	...
	/// <summary>
	/// Id of the immediate parent of the contained <see cref="EcSidebarItem"/> components.
	/// </summary>
	internal string navId = "ec" + Guid.NewGuid().ToString("N");

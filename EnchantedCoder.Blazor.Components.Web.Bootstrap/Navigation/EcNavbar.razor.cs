...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcNavbar">https://EnchantedCoder.blazor.eu/components/EcNavbar</see>
/// </summary>
public partial class EcNavbar
{
	/// <summary>
	/// Color (background).
	...
	/// <summary>
	/// Responsive expand setting (breakpoint) for <see cref="EcNavbar"/>.<br/>

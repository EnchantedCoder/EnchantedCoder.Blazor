...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxInputTags">https://EnchantedCoder.blazor.eu/components/HxInputTags</see>
/// </summary>
public class HxInputTags : HxInputBase<List<string>>, IInputWithSize, IInputWithPlaceholder, IInputWithLabelType
{
	...
	protected override void BuildRenderInput(RenderTreeBuilder builder)
	{
		...
		builder.AddAttribute(1011, nameof(HxInputTagsInternal.Placeholder), (labelTypeEffective == EnchantedCoder.Blazor.Components.Web.Bootstrap.LabelType.Floating) ? "placeholder" : Placeholder);

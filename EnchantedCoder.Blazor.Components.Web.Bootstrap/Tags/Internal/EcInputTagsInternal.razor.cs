...
/// <summary>
/// Internal implementation for <see cref="EcInputTags"/>.
/// </summary>
public partial class EcInputTagsInternal
{
	/// <summary>
	...
	/// Default is <c>false</c>.
	/// Consider enabling <see cref="EcInputTags.ShowAddButton"/> when using <c>Naked</c>.
	/// </summary>
	...
	private EcInputTagsAutosuggestInputInternal autosuggestInput;
	private bool dataProviderInProgress;
	private DotNetObjectReference<EcInputTagsInternal> dotnetObjectReference;

	public EcInputTagsInternal()
	{
	...
	[JSInvokable("EcInputTagsInternal_HandleInputKeyDown")]
	...
	protected override void OnParametersSet()
	{
		...
		{
			InputId = "ec" + Guid.NewGuid().ToString("N");
		}
	}
	...
	{
		jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(EcInputTags));
	}

	[JSInvokable("EcInputTagsInternal_HandleDropdownHidden")]
	...
	protected string GetNakedCssClasses()
	{
		...
		return CssClassHelper.Combine("ec-input-tags-naked", this.InputSizeEffective switch
		{
			InputSize.Regular => null,
			InputSize.Small => "ec-input-tags-naked-sm",
			InputSize.Large => "ec-input-tags-naked-lg",

...
/// Usually being used to present filter-criteria gathered by <see cref="EcFilterForm{TModel}"/>.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcChipList">https://EnchantedCoder.blazor.eu/components/EcChipList</see>
/// </summary>
public partial class EcChipList
{
	/// <summary>
	/// Application-wide defaults for the <see cref="EcChipList"/>.
	/// </summary>
	...
	protected BadgeSettings ChipBadgeSettingsEffective => this.ChipBadgeSettings ?? this.GetSettings()?.ChipBadgeSettings ?? this.GetDefaults().ChipBadgeSettings ?? throw new InvalidOperationException(nameof(ChipBadgeSettings) + " default for " + nameof(EcChipList) + " has to be set.");
	...
	/// Default is <c>false</c> (can be changed with <code>EcChipList.Defaults.ShowResetButton</code>.
	/// </summary>
	[Parameter] public bool? ShowResetButton { get; set; }
	protected bool ShowResetButtonEffective => this.ShowResetButton ?? this.GetSettings()?.ShowResetButton ?? GetDefaults().ShowResetButton ?? throw new InvalidOperationException(nameof(ShowResetButton) + " default for " + nameof(EcChipList) + " has to be set.");

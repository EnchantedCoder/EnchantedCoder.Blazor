...
/// <summary>
/// Extension methods for <see cref="IEcMessengerService"/>.
/// </summary>
public static class EcMessengerServiceExtensions
{
	/// <summary>
	...
	/// </summary>
	public static void AddInformation(this IEcMessengerService messenger, string message)
	{
	...
	/// Adds and shows an informational message. Message is automatically hidden 5 seconds after showing up.
	/// </summary>
	public static void AddInformation(this IEcMessengerService messenger, string title, string message)
	{
	...
	/// </summary>
	public static void AddWarning(this IEcMessengerService messenger, string message)
	{
	...
	/// Adds and shows a warning message.
	/// </summary>
	public static void AddWarning(this IEcMessengerService messenger, string title, string message)
	{
		Contract.Requires<ArgumentNullException>(messenger != null, nameof(messenger));
	...
	/// </summary>
	public static void AddError(this IEcMessengerService messenger, string message)
	{
	...
	/// Adds and shows an error message.
	/// </summary>
	public static void AddError(this IEcMessengerService messenger, string title, string message)
	{
		Contract.Requires<ArgumentNullException>(messenger != null, nameof(messenger));

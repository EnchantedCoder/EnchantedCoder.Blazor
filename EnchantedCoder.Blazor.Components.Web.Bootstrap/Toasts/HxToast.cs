...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/HxToast">https://EnchantedCoder.blazor.eu/components/HxToast</see>
/// </summary>
public partial class HxToast : ComponentBase, IAsyncDisposable
{
	...
	protected override async Task OnAfterRenderAsync(bool firstRender)
	{
		...
		if (firstRender)
		{
			jsModule ??= await JSRuntime.ImportEnchantedCoderBlazorBootstrapModuleAsync(nameof(HxToast));
			if (disposed)
			{
				return;
			}

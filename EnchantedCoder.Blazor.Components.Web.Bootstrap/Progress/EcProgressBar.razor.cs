...
/// <summary>
/// A progress bar to be placed inside <see cref="EcProgress" />.
/// </summary>
public partial class EcProgressBar
{
	/// <summary>
	...
	[CascadingParameter] protected EcProgress ProgressBarContainer { get; set; }

...
/// A wrapping component for the <see cref="EcProgressBar" />.<br />
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcProgress">https://EnchantedCoder.blazor.eu/components/EcProgress</see>
/// </summary>
public partial class EcProgress
{
	/// <summary>
	/// Content consisting of one or multiple <c>EcProgressBar</c> components.
	/// </summary>

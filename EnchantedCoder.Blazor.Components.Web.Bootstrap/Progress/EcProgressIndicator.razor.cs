...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcProgressIndicator">https://EnchantedCoder.blazor.eu/components/EcProgressIndicator</see>
/// </summary>
public partial class EcProgressIndicator : IDisposable
{
	/// <summary>
	/// Application-wide defaults for the <see cref="EcProgressIndicator"/>.
	/// </summary>
	public static ProgressIndicatorSettings Defaults { get; set; }

	static EcProgressIndicator()
	{
	...
	protected int DelayEffective => this.Delay ?? GetSettings()?.Delay ?? GetDefaults()?.Delay ?? throw new InvalidOperationException(nameof(Delay) + " default for " + nameof(EcProgressIndicator) + " has to be set.");

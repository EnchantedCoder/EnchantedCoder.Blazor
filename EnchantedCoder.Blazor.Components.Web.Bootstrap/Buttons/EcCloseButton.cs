...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcCloseButton">https://EnchantedCoder.blazor.eu/components/EcCloseButton</see>
/// </summary>
public class EcCloseButton : EcButton
{
	/// <summary>
	/// Application-wide defaults for <see cref="EcCloseButton"/> and derived components.
	/// </summary>
	...
	protected bool WhiteEffective => White ?? GetDefaults().White ?? throw new InvalidOperationException(nameof(White) + " default for " + nameof(EcCloseButton) + " has to be set.");

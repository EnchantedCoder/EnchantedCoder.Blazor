export function show(element, ecOffcanvasDotnetObjectReference, closeOnEscape, scrollingEnabled) {
	...
	element.ecOffcanvasDotnetObjectReference = ecOffcanvasDotnetObjectReference;
...
function handleOffcanvasShown(event) {
	event.target.ecOffcanvasDotnetObjectReference.invokeMethodAsync('EcOffcanvas_HandleOffcanvasShown');
}

function handleOffcanvasHidden(event) {
	event.target.ecOffcanvasDotnetObjectReference.invokeMethodAsync('EcOffcanvas_HandleOffcanvasHidden');
...
export function dispose(element) {
	...
	element.ecOffcanvasDotnetObjectReference = null;

...
public class EcInputBaseTests
{
	[TestClass]
	public class EcInputBase_Renders_WithoutEditContext_TestCase
	{
		[TestMethod]
		public void EcInputBase_Renders_WithoutEditContext()
		{
			// Arrange
			...
			{
				builder.OpenComponent<EcComponent>(0);
		...
		private class EcComponent : EcInputBase<string>
		{

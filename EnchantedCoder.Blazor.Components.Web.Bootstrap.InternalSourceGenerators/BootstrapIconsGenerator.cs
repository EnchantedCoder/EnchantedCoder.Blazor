...
namespace EnchantedCoder.Blazor.Components.Web.Bootstrap.InternalSourceGenerators;
...
#pragma warning restore RS1035 // Do not use APIs banned for analyzers
			...
			sb.AppendLine("namespace EnchantedCoder.Blazor.Components.Web.Bootstrap");
			sb.AppendLine("{");

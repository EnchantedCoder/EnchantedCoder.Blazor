...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcIcon">https://EnchantedCoder.blazor.eu/components/EcIcon</see>
/// You can add your own icon-set easily.
/// </summary>
public class EcIcon : ComponentBase
{
	/// <summary>
	/// Icon to display.
	/// </summary>

...
/// <summary>
/// Rendering a <c>EcRedirectTo</c> will navigate to a new location.<br/>
...
/// Full documentation and demos: <see href="https://EnchantedCoder.blazor.eu/components/EcRedirectTo">https://EnchantedCoder.blazor.eu/components/EcRedirectTo</see>
/// </summary>
public class EcRedirectTo : ComponentBase
{
	/// <summary>
	/// URI to navigate to.
	/// </summary>
